        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item active" href="request_money.php">Request For Money</a>
...
<!--            </li>-->
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Content -->
                <h2>Money Request  List</h2>
                <hr>
                <div class="card">
                    <div class="card-header">
                        Total Money Request List
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        <div class="table-striped table-responsive">
                            <?php
                                $counter = 1;
                                $lists = $dataManipulation->viewAllMoneyRequestList();
                                if($lists != false){
                                    ?>
