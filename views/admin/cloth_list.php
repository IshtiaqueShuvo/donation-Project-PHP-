                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-striped table-responsive">
                            <?php
                                $counter = 1;
                                $clothLists = $dataManipulation->viewAllClothList();
                                if($clothLists != false){
                                    ?>
                                    <table class="table table-bordered table-hover">
                                        ...
                                        foreach ($clothLists as $clothList){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $clothList->quantity?>&nbsp;pieces
                                                </td>
                                                ...
                                                <td>
<!--                                                    <a href="../process_data/update_data.php?productId=--><?php //echo $clothList->id ?><!--" class="smaller btn btn-success">Complete Donation (<i class="fa fa-check"></i> )</a>-->
                                            ...
                                            <tr style="display:none">
                                                <td colspan="8">
                                                    <div class="donate-div position-relative">
                                                        <a href="javascript:;" class="btn btn-danger btn-sm close-btn" style="position: absolute; right:0;top:-10px;z-index: 99">Close</i></a>
                                                        <form action="../process_data/update_data.php" method="post">
                                                            <div class="row" style="margin-left:-12px;margin-right:-12px;">
                                                                <div class="col-md-3">
                                                                    <p class="mb-0">
                                                                        Total item to donate : <?php echo $clothList->quantity?>
                                                                    </p>
                                                                    <p class="mb-0">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="">
                                                                        <label>&nbsp</label>
                                                                        <input class="btn btn-success btn-block" type="submit" name="makeClothDonation" value="Donate">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
