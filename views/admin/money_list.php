            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if(isset($_SESSION['transactionCheck'])){
                            echo $_SESSION['transactionCheck'];
                            unset($_SESSION['transactionCheck']);
                        }
                        ?>
                        <div class="table-striped table-responsive">
                            <?php
                                $counter = 1;
                                $clothLists = $dataManipulation->viewAllMoneyList();
                                if($clothLists != false){
                                    ?>
                                    <table class="table table-bordered table-hover">
                                        ...
                                        foreach ($clothLists as $clothList){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $clothList->amount?>
                                                </td>

                                                <td>
                                                    <?php echo $clothList->transaction?>
                                                </td>

                                                <td>
                                                    <?php
                                                    if($clothList->transaction_match=='yes'){
                                                        ?>
                                                        <span class="bg-success text-light">Transaction Succesfull</span>
                                                        <?php
                                                    }else{
                                                        ?>
                                                        <a href="../process_data/update_data.php?gotId=<?php echo $clothList->id?>" class="smaller btn btn-info">
                                                            Got the money
                                                        </a>
                                                        <?php
                                                    }
                                                ...
                                                <td>
                                                    ...
                                                    if($clothList->transaction_match=='yes'){
//                                                        ?>
<!--                                                        <a href="../process_data/update_data.php?moneyProductId=--><?php //echo $clothList->id ?><!--" class="smaller btn btn-success">Complete Donation (<i class="fa fa-check"></i> )</a>-->
                                                        <a href="javascript:;" class="btn btn-primary donate-btn">Donate <i class="fa fa-chevron-down" </a>
                                                        <?php
                                                    }else{
                                                       ?>
<!--                                                        <a href="../process_data/update_data.php?foodProductId=--><?php //echo $clothList->id ?><!--" class="smaller btn btn-success disabled">Complete Donation (<i class="fa fa-check"></i> )</a>-->
                                                        <?php
                                                    }
//                                                    ?>
                                                    ...
                                                    <div class="donate-div position-relative">
                                                        ...
                                                        <form action="../process_data/update_data.php" method="post">
                                                            <div class="row" style="margin-left:-12px;margin-right:-12px;">
                                                                <div class="col-md-3">
                                                                    <p class="mb-0">
                                                                        Total Money to donate : <?php echo $clothList->amount?>
                                                                    </p>
                                                                    <p class="mb-0">
                                                                        Available Money : <?php echo $clothList->available_item ?>
                                                                    </p>
                                                                </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="">
                                                                        ...
                                                                        <input type="hidden" value="<?php echo $clothList->amount; ?>" name="totalItem">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="">
                                                                        <label>&nbsp</label>
                                                                        <input class="btn btn-success btn-block" type="submit" name="makeMoneyDonation" value="Donate">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
