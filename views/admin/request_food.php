        ...
        <ul class="sidebar navbar-nav">
            ...
            <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                    ...
                    <a class="dropdown-item active" href="request_food.php">Request For Food</a>
...
<!--            </li>-->
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Content -->
                <h2>Food Request  List</h2>
                <hr>
                <div class="card">
                    <div class="card-header">
                        Total Food Request List
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        <div class="table-striped table-responsive">
                            <?php
                                $counter = 1;
                                $clothLists = $dataManipulation->viewAllFoodRequestList();
                                if($clothLists != false){
                                    ?>
