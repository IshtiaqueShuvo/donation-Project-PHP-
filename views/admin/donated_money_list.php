            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if(isset($_SESSION['moneyDelivered'])){
                            echo $_SESSION['moneyDelivered'];
                            unset($_SESSION['moneyDelivered']);
                        }
                        ?>
                        <div class="table-striped table-responsive">
                            <?php
                                $counter = 1;
                                $clothLists = $dataManipulation->viewDonatedMoneyList();
                                if($clothLists != false){
                                    ?>
                                    <table class="table table-bordered table-hover">
                                        ...
                                        foreach ($clothLists as $clothList){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $clothList->donatedPerson?>
                                                </td>
                                                <td>
