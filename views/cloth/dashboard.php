                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card text-white bg-primary o-hidden mb-lg-2">
                                <a class="card-body" href="cloth_list.php">
                                    <div class="mr-5" style="color:#fff;">Cloth List</div>
                                </a>
                            </div>

                            <div class="card text-white bg-primary o-hidden">
                                <a class="card-body" href="add_cloth.php">
                                    <div class="mr-5" style="color:#fff;">Donate Cloth</div>
                                </a>
                            </div>
